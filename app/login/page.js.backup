        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <div style={{
              ...
              <svg style={{ height: '32px', width: '32px', color: 'white' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <button
                ...
                style={{
                  ...
                  fontWeight: '500',
                  color: 'white',
                  background: loading ? 'rgba(168, 85, 247, 0.7)' : 'linear-gradient(135deg, #9333ea, #ec4899)',
              ...
              >
                {loading ? (
                  <div style={{ display: 'flex', alignItems: 'center' }}>
                    <svg className="animate-spin" style={{ marginRight: '12px', height: '20px', width: '20px', color: 'white' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
